...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [_ADJUST] = LAYOUT_ortho_5x12(
        ...
        _______, UG_TOGG, UG_PREV, UG_NEXT, _______, _______, _______, _______, _______, _______, _______, KC_DEL,
        _______, UG_HUEU, UG_SATU, UG_VALU, UG_SPDU, _______, _______, QWERTY,  COLEMAK, DVORAK,  _______, _______,
